...
public class FractalExplorer {
    ...
    class ResetButtonHandler implements ActionListener { // используется нериализованный метод (класс интерфейс), который реализуется, implements означает, что используются элементы интерфейса в классе, а extends означает, что создается подкласс от класса
